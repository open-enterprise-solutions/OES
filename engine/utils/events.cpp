...
wxString wxFrameEvent::GetEventName()
{
	CASE(wxEVT_PROJECT_LOADED)
		...
		CASE(wxEVT_EVENT_HANDLER_MODIFIED)
...
wxFrameObjectEvent::wxFrameObjectEvent(wxEventType commandType, IControlElement* object)
...
wxFrameEventHandlerEvent::wxFrameEventHandlerEvent(wxEventType commandType, Event* event)
	: wxFrameEvent(commandType), m_event(event)
{
}
