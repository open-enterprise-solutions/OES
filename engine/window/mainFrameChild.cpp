...
// ctor for a valueFrame showing the given view of the specified document
...
bool CDocChildFrame::Create(wxDocument *doc,
	...
	const wxString& name)
{
	if (!wxDocChildFrameAnyBase::Create(doc, view, this) || !wxAuiMDIChildFrame::Create(parent, id, title, pos, size, style, name))
		return false;
