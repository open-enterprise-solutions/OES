...
void wxWatchWindowDataEvent::AddWatch(wxString name, wxString value, wxString type, bool hasAttributes)
{
	m_aExpressions.emplace_back(name, value, type, hasAttributes, itemID); 
}

void wxWatchWindowDataEvent::AddWatch(wxString name, wxString value, wxString type, bool hasAttributes, wxTreeItemId item)
{
