...
//*                              Override attribute                          *
//****************************************************************************
void CObjectDataProcessorValue::SetAttribute(CAttributeParameters &aParams, CValue &vObject)        //установка атрибута
{
...
CValue CObjectDataProcessorValue::GetAttribute(CAttributeParameters &aParams)                   //значение атрибута
{
	wxString sName = GetAttributeName(aParams.GetAttributeIndex()), sAlias = m_methods->GetAttributeAlias(aParams.GetAttributeIndex());
