...
private:
	...
	//default attributes 
	CAttributeObject *m_attributeNumber;
	CAttributeObject *m_attributeDate;
	CAttributeObject *m_attributePosted;
...
public:
	...
	CObjectDocumentValue(CMetaObjectDocumentValue *metaObj);
	CObjectDocumentValue(CMetaObjectDocumentValue *metaObj, const Guid &guid);
	...
	virtual IDataObjectValue *CopyObjectValue() { return new CObjectDocumentValue(*this); }
