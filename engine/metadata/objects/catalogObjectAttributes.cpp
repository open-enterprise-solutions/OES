...
//*                              Override attribute                          *
//****************************************************************************
void CObjectCatalogValue::SetAttribute(CAttributeParameters &aParams, CValue &vObject)        //установка атрибута
{
...
CValue CObjectCatalogValue::GetAttribute(CAttributeParameters &aParams)                   //значение атрибута
{
	wxString sName = GetAttributeName(aParams.GetAttributeIndex()), sAlias = m_methods->GetAttributeAlias(aParams.GetAttributeIndex());
