...
CAction CMetaObjectDataProcessorValue::GetActions(form_identifier_t formType)
{
...
void CMetaObjectDataProcessorValue::AddActions(CAction &actions, form_identifier_t formType)
{
...
void CObjectDataProcessorValue::ExecuteAction(unsigned int action)
{
	//switch (action)
	//{
