...
CAction CMetaObjectDocumentValue::GetActions(form_identifier_t formType)
{
...
void CMetaObjectDocumentValue::AddActions(CAction &actions, form_identifier_t formType)
{
...
void CObjectDocumentValue::ExecuteAction(unsigned int action)
{
	switch (action)
	{
