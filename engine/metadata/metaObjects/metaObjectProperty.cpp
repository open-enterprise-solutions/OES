...
void IMetaObject::OnPropertyCreated(Property *m_property)
{
}

void IMetaObject::OnPropertySelected(Property *m_property)
{
}

void IMetaObject::OnPropertyChanged(Property *m_property)
{
...
void IMetaObject::SetPropertyData(Property *property, const CValue &srcValue)
{
	...
	case PropertyType::PT_OPTION:
	{
		...
		{
			if (option.m_dblVal == m_dblVal) property->SetValue(m_dblVal);
		}
		break;
	}
