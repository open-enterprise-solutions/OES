#include "chartBox.h"
#include "window/charts/wxcharts.h"

//***********************************************************************************
//*                           IMPLEMENT_DYNAMIC_CLASS                               *
//***********************************************************************************

wxIMPLEMENT_DYNAMIC_CLASS(CValueChartBox, CValueWindow);

//***********************************************************************************
//*                                 Value Notebook                                  *
//***********************************************************************************

CValueChartBox::CValueChartBox() : CValueWindow(), m_name("chartbox")
{
	PropertyCategory *m_categoryNotebook = new PropertyCategory("Chart");
...
CValue CValueChartBox::Method(CMethodParameters &aParams)       //вызов метода
{
...
wxObject* CValueChartBox::Create(wxObject* parent, IVisualHost *visualHost)
{
	...
	*/
	...
	// Create a top-level panel to hold all the contents of the valueFrame
...
void CValueChartBox::OnCreated(wxObject* wxobject, wxWindow* wxparent, IVisualHost *visualHost)
{
